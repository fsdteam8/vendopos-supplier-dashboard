import {
  useProfile,
  useUpdateProfile,
} from "@/app/features/profile/hooks/useProfile";
    ...
    if (profile?.data) {
      setFormData({
        ...
        dateOfBirth: profile.data.dateOfBirth
          ? new Date(profile.data.dateOfBirth).toISOString().split("T")[0]
          : "",
      });
    }
  }, [profile]);
    ...
    <form onSubmit={handleSubmit} className="space-y-8">
      ...
      <div>
        ...
        <div className="mb-8">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              >
                <div className="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors font-medium text-sm flex items-center gap-2">
        ...
        <button
          type="submit"
          disabled={isPending}
          className="mt-6 px-6 py-2 bg-[#09714e] text-white rounded-lg hover:bg-[#09714e] transition-colors font-medium text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 cursor-pointer focus:ring-[#1B7D6E] disabled:opacity-50 disabled:cursor-not-allowed"
        >
