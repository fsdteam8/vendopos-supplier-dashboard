...
export default function Payments() {
  ...
  return (
    <div className="p-8 space-y-8">
      ...
      {/* Dialog for incomplete onboarding */}
      <Dialog open={profile?.data && isOnboarded === false}>
        <DialogContent
          className="sm:max-w-md shadow-2xl border-primary/20"
          showOverlay={false}
        ...
        >
          <DialogHeader>
            ...
            <DialogDescription>
              Please complete onboarding to enable payouts and transactions.
            </DialogDescription>
          </DialogHeader>

          <div className="flex flex-col gap-4 py-4">
            <p className="text-sm text-red-600 font-medium">
              You cannot receive payouts until your account is verified.
            </p>
          </div>
